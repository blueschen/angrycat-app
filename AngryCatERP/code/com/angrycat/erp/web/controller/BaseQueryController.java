...
public abstract class BaseQueryController<T, R> implements Serializable {
	...
	private QueryBaseService<T, R> queryBaseService; 
	
	@Autowired
	@Qualifier("queryBaseService")
	private QueryBaseService<T, R> findTargetService; 
	/**
	 * 取得對應資料夾路徑的模組名稱。
	...
	QueryBaseService<T, R> getQueryBaseService(){
		return queryBaseService;
	}
	
	QueryBaseService<T, R> getFindTargetService(){
		return findTargetService;
	}
	...
	public void downloadExcel(HttpServletResponse response){
		File tempFile = getExcelExporter().normal(getQueryBaseService());
